...
def test_repo_layout(repo_root: Path) -> None:
    ...
    must_exist = [
        ...
        "src/builder/hyperlinks.py",
        "src/builder/pdf_convert.py",
        "src/sender",
        "src/sender/__init__.py",
        "src/sender/indeed.py",
        "src/sender/glassdoor.py",
        "src/sender/fields.py",
        "src/sender/questions.py",
        "src/sender/bank.py",
        "src/sender/cover_letter.py",
        "src/sender/pdf_render.py",
        "src/sender/voice.py",
        "src/state",
...
def test_config_yaml_loads_and_has_required_sections(config_path: Path) -> None:
    ...
    required = {
        "personal", "scheduler", "scraper", "parser", "selection",
        "scoring", "queue", "builder", "sender", "voice", "cover_pdf",
